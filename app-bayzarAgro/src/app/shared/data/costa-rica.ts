...
export const CANTONES: { [key: string]: string[] } = {
...
export const DISTRITOS: { [provincia: string]: { [canton: string]: string[] } } = {
  "San José": {
    ...
    "Pérez Zeledón": ["San Isidro de El General", "El General", "Daniel Flores", "Rivas", "San Pedro", "Platanares", "Pejivalle", "Cajón", "Barú", "Río Nuevo", "Páramo", "La Amistad"],
  ...
  "Guanacaste": {
    ...
    "Bagaces": ["Bagaces", "La Fortuna", "Mogote", "Río Naranjo", "Pijije"],
  ...
  "Puntarenas": {
    ...
    "Buenos Aires": ["Buenos Aires", "Volcán", "Potrero Grande", "Boruca", "Pilas", "Colinas", "Chánguena", "Biolley", "Brunka", "Cabagra"],
